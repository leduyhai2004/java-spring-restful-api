...
import vn.duyhai.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.duyhai.jobhunter.service.FileService;
import vn.duyhai.jobhunter.util.anotation.ApiMessage;
import vn.duyhai.jobhunter.util.error.StorageException;
...
public class FileController {
    @Value("${duyhai.upload-file.base-uri}")
    ...
    public ResponseEntity<ResUploadFileDTO> upload( @RequestParam(name ="file", required= false) MultipartFile file,
        ...
        if(!isValid){
            throw new StorageException("Invalid Extension file, only allows "+allowedExtensions.toString());
        }
